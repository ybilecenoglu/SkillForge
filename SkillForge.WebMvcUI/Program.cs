...
using SkillForge.Core.Aspect.Autofac;
using SkillForge.Core.CrossCuttingConcern.Caching;
using SkillForge.Core.DependencyResolvers;
using SkillForge.Core.Extensions;
using SkillForge.Core.Utilities.IoC;
using SkillForge.Business;
using SkillForge.Business.Concrate;
...
using SkillForge.DataAccess.Concrate;
using SkillForge.Entities.Model;
using SkillForge.WebMvcUI.Common;
...
//     FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(),"wwwroot")), RequestPath="/SkillForge.WebMvcUI/wwwroot"
